...
(function (exports, undefined) {
	...
	var _compose = regeneratorRuntime.mark(function _compose(sigma, tau) {
		...
		return regeneratorRuntime.wrap(function _compose$(context$2$0) {
	...
	var _cycles = regeneratorRuntime.mark(function _cycles(sigma, used) {
		...
		return regeneratorRuntime.wrap(function _cycles$(context$2$0) {
			while (1) switch (context$2$0.prev = context$2$0.next) {
				case 0:
	...
	var _itranspositions = regeneratorRuntime.mark(function _itranspositions(sigma, used) {
		...
		return regeneratorRuntime.wrap(function _itranspositions$(context$2$0) {
			while (1) switch (context$2$0.prev = context$2$0.next) {
				case 0:
	...
	var _transpositions = regeneratorRuntime.mark(function _transpositions(cycles) {
		...
		return regeneratorRuntime.wrap(function _transpositions$(context$2$0) {
			while (1) switch (context$2$0.prev = context$2$0.next) {
				case 0:
	...
	var cycles = regeneratorRuntime.mark(function cycles(sigma) {
		return regeneratorRuntime.wrap(function cycles$(context$2$0) {
			while (1) switch (context$2$0.prev = context$2$0.next) {
				case 0:
					return context$2$0.delegateYield(_cycles(sigma, used(sigma.length)), 't4', 1);
	...
	var itranspositions = regeneratorRuntime.mark(function itranspositions(sigma) {
		return regeneratorRuntime.wrap(function itranspositions$(context$2$0) {
			while (1) switch (context$2$0.prev = context$2$0.next) {
				case 0:
					return context$2$0.delegateYield(_itranspositions(sigma, used(sigma.length)), 't5', 1);
	...
	exports.used = used;
})(typeof exports === 'undefined' ? undefined.permutation = {} : exports);